package cn.edu.swl.s07150741.alertdialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void dialog2(){
        ...
        dialog.setButton(DialogInterface.BUTTON_NEGATIVE,"平时很轻松",listener);
        dialog.show();
    }
    public void dialog3(){
        dialog = new AlertDialog.Builder(this).create();
    ...
    public void dialog4(){
        final String item[] = new String[]{"北京","上海","天津"};
    ...
    public void dialog5(){
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE,"确定",slistener);
        dialog.show();
    }
    public void dialog6(){
        final String item[] = new String[]{"上海","北京","广州"};
        final boolean bSelect[] = new boolean[item.length];
        DialogInterface.OnClickListener slistener = new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
    ...
    public void dialog7(){
      ...
      final EditText tEdit = (EditText) layout.findViewById(R.id.edit1);
        dialog =new AlertDialog.Builder(this).create();
